/**
 * angular-input-masks Personalized input masks for AngularJS
 * 
 * @version v4.3.0
...
// This function will be a part of public API when UTC function will be
// implemented.
 ...
 * @param {Number}
 *          amount - the amount of milliseconds to be added
 * @param {Options}
 *          [options] - the object with options. See [Options]{@link https://date-fns.org/docs/Options}
 * @param {0|1|2}
 *          [options.additionalDigits=2] - passed to `toDate`. See [toDate]{@link https://date-fns.org/docs/toDate}
 ...
 * 
 * @example // Add 750 milliseconds to 10 July 2014 12:45:30.000: var result =
 *          addMilliseconds(new Date(2014, 6, 10, 12, 45, 30, 0), 750) //=> Thu
 *          Jul 10 2014 12:45:30.750
 */
 ...
 *          date - the date to be changed
 * @param {Number}
 *          amount - the amount of minutes to be added
 * @param {Options}
 *          [options] - the object with options. See [Options]{@link https://date-fns.org/docs/Options}
 * @param {0|1|2}
 *          [options.additionalDigits=2] - passed to `toDate`. See [toDate]{@link https://date-fns.org/docs/toDate}
 ...
 *           `options.additionalDigits` must be 0, 1 or 2
 * 
 * @example // Add 30 minutes to 10 July 2014 12:00:00: var result =
 *          addMinutes(new Date(2014, 6, 10, 12, 0), 30) //=> Thu Jul 10 2014
 *          12:30:00
 */
 ...
 * 
 * Accepted tokens: | Unit | Token | Result examples |
 * |-------------------------|-------|----------------------------------| |
 * Month | M | 1, 2, ..., 12 | | | Mo | 1st, 2nd, ..., 12th | | | MM | 01, 02,
 * ..., 12 | | | MMM | Jan, Feb, ..., Dec | | | MMMM | January, February, ...,
 * December | | Quarter | Q | 1, 2, 3, 4 | | | Qo | 1st, 2nd, 3rd, 4th | | Day
 * of month | D | 1, 2, ..., 31 | | | Do | 1st, 2nd, ..., 31st | | | DD | 01,
 * 02, ..., 31 | | Day of year | DDD | 1, 2, ..., 366 | | | DDDo | 1st, 2nd,
 * ..., 366th | | | DDDD | 001, 002, ..., 366 | | Day of week | d | 0, 1, ..., 6 | | |
 * do | 0th, 1st, ..., 6th | | | dd | Su, Mo, ..., Sa | | | ddd | Sun, Mon, ...,
 * Sat | | | dddd | Sunday, Monday, ..., Saturday | | Day of ISO week | E | 1,
 * 2, ..., 7 | | ISO week | W | 1, 2, ..., 53 | | | Wo | 1st, 2nd, ..., 53rd | | |
 * WW | 01, 02, ..., 53 | | Year | YY | 00, 01, ..., 99 | | | YYYY | 1900, 1901,
 * ..., 2099 | | ISO week-numbering year | GG | 00, 01, ..., 99 | | | GGGG |
 * 1900, 1901, ..., 2099 | | AM/PM | A | AM, PM | | | a | am, pm | | | aa |
 * a.m., p.m. | | Hour | H | 0, 1, ... 23 | | | HH | 00, 01, ... 23 | | | h | 1,
 * 2, ..., 12 | | | hh | 01, 02, ..., 12 | | Minute | m | 0, 1, ..., 59 | | | mm |
 * 00, 01, ..., 59 | | Second | s | 0, 1, ..., 59 | | | ss | 00, 01, ..., 59 | |
 * 1/10 of second | S | 0, 1, ..., 9 | | 1/100 of second | SS | 00, 01, ..., 99 | |
 * Millisecond | SSS | 000, 001, ..., 999 | | Timezone | Z | -01:00, +00:00, ...
 * +12:00 | | | ZZ | -0100, +0000, ..., +1200 | | Seconds timestamp | X |
 * 512969520 | | Milliseconds timestamp | x | 512969520900 | | Long format | LT |
 * 05:30 a.m. | | | LTS | 05:30:15 a.m. | | | L | 07/02/1995 | | | l | 7/2/1995 | | |
 * LL | July 2 1995 | | | ll | Jul 2 1995 | | | LLL | July 2 1995 05:30 a.m. | | |
 * lll | Jul 2 1995 05:30 a.m. | | | LLLL | Sunday, July 2 1995 05:30 a.m. | | |
 ...
 *          [options.additionalDigits=2] - passed to `toDate`. See [toDate]{@link https://date-fns.org/docs/toDate}
 * @param {Locale}
 *          [options.locale=defaultLocale] - the locale object. See [Locale]{@link https://date-fns.org/docs/Locale}
 ...
 * 
 * @example // Represent 11 February 2014 in middle-endian format: var result =
 *          format( new Date(2014, 1, 11), 'MM/DD/YYYY' ) //=> '02/11/2014'
 * 
 * @example // Represent 2 July 2014 in Esperanto: import { eoLocale } from
 *          'date-fns/locale/eo' var result = format( new Date(2014, 6, 2), 'Do
 *          [de] MMMM YYYY', {locale: eoLocale} ) //=> '2-a de julio 2014'
 */
function format(dirtyDate, dirtyFormatStr, dirtyOptions) {
  ...
  // This ensures that when UTC functions will be implemented, locales will be
	// compatible with them.
  // See an issue about UTC functions:
  ...
  // When UTC functions will be implemented, options._originalDate will likely
	// be a part of public API.
  // Right now, please don't use it in locales. If you have to use an original
	// date,
 ...
 *           `options.additionalDigits` must be 0, 1 or 2
 * 
 * @example // For the valid date: var result = isValid(new Date(2014, 1, 31))
 *          //=> true
 * 
 * @example // For the value, convertable into a date: var result =
 *          isValid('2014-02-31') //=> true
 * 
 * @example // For the invalid date: var result = isValid(new Date('')) //=>
 *          false
 */
 ...
 * @summary Build `formatLong` property for locale used by `format`,
 *          `formatRelative` and `parse` functions.
 * 
 * @description Build `formatLong` property for locale used by `format`,
 *              `formatRelative` and `parse` functions. Returns a function which
 *              takes one of the following tokens as the argument: `'LTS'`,
 *              `'LT'`, `'L'`, `'LL'`, `'LLL'`, `'l'`, `'ll'`, `'lll'`, `'llll'`
 *              and returns a long format string written as `format` token
 *              strings. See [format]{@link https://date-fns.org/docs/format}
 * 
 * `'l'`, `'ll'`, `'lll'` and `'llll'` formats are built automatically by
 * shortening some of the tokens from corresponding unshortened formats (e.g.,
 * if `LL` is `'MMMM DD YYYY'` then `ll` will be `MMM D YYYY`)
 * 
 * @param {Object}
 *          obj - the object with long formats written as `format` token strings
 * @param {String}
 *          obj.LT - time format: hours and minutes
 * @param {String}
 *          obj.LTS - time format: hours, minutes and seconds
 * @param {String}
 *          obj.L - short date format: numeric day, month and year
 * @param {String}
 *          [obj.l] - short date format: numeric day, month and year (shortened)
 * @param {String}
 *          obj.LL - long date format: day, month in words, and year
 * @param {String}
 *          [obj.ll] - long date format: day, month in words, and year
 *          (shortened)
 * @param {String}
 *          obj.LLL - long date and time format
 * @param {String}
 *          [obj.lll] - long date and time format (shortened)
 * @param {String}
 *          obj.LLLL - long date, time and weekday format
 * @param {String}
 *          [obj.llll] - long date, time and weekday format (shortened)
 * @returns {Function} `formatLong` property of the locale
 * 
 * @example // For `en-US` locale: locale.formatLong = buildFormatLongFn({ LT:
 *          'h:mm aa', LTS: 'h:mm:ss aa', L: 'MM/DD/YYYY', LL: 'MMMM D YYYY',
 *          LLL: 'MMMM D YYYY h:mm aa', LLLL: 'dddd, MMMM D YYYY h:mm aa' })
 */
 ...
 * @category Locale Helpers
 * @summary Build `localize.weekdays`, `localize.months` and
 *          `localize.timesOfDay` properties for the locale.
 * 
 * @description Build `localize.weekdays`, `localize.months` and
 *              `localize.timesOfDay` properties for the locale. If no `type` is
 *              supplied to the options of the resulting function, `defaultType`
 *              will be used (see example).
 * 
 * @param {Object}
 *          values - the object with arrays of values
 * @param {String}
 *          defaultType - the default type for the localize function
 * @returns {Function} the resulting function
 * 
 * @example var weekdayValues = { narrow: ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr',
 *          'Sa'], short: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
 *          long: ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday',
 *          'Friday', 'Saturday'] } locale.localize.weekdays =
 *          buildLocalizeArrayFn(weekdayValues, 'long')
 ...
 * @category Locale Helpers
 * @summary Build `localize.weekday`, `localize.month` and `localize.timeOfDay`
 *          properties for the locale.
 * 
 * @description Build `localize.weekday`, `localize.month` and
 *              `localize.timeOfDay` properties for the locale used by `format`
 *              function. If no `type` is supplied to the options of the
 *              resulting function, `defaultType` will be used (see example).
 * 
 * `localize.weekday` function takes the weekday index as argument (0 - Sunday).
 * `localize.month` takes the month index (0 - January). `localize.timeOfDay`
 * takes the hours. Use `indexCallback` to convert them to an array index (see
 * example).
 * 
 * @param {Object}
 *          values - the object with arrays of values
 ...
 *          defaultType - the default type for the localize function
 * @param {Function}
 *          [indexCallback] - the callback which takes the resulting function
 *          argument and converts it into value array index
 * @returns {Function} the resulting function
 * 
 * @example var timeOfDayValues = { uppercase: ['AM', 'PM'], lowercase: ['am',
 *          'pm'], long: ['a.m.', 'p.m.'] } locale.localize.timeOfDay =
 *          buildLocalizeFn(timeOfDayValues, 'long', function (hours) { // 0 is
 *          a.m. array index, 1 is p.m. array index return (hours / 12) >= 1 ? 1 :
 *          0 }) locale.localize.timeOfDay(16, {type: 'uppercase'}) //=> 'PM'
 ...
 * @name buildMatchFn
 * @category Locale Helpers
 * @summary Build `match.weekdays`, `match.months` and `match.timesOfDay`
 *          properties for the locale.
 * 
 * @description Build `match.weekdays`, `match.months` and `match.timesOfDay`
 *              properties for the locale used by `parse` function. If no `type`
 *              is supplied to the options of the resulting function,
 *              `defaultType` will be used (see example). The result of the
 *              match function will be passed into corresponding parser function
 *              (`match.weekday`, `match.month` or `match.timeOfDay`
 *              respectively. See `buildParseFn`).
 * 
 * @param {Object}
 *          values - the object with RegExps
 * @param {String}
 *          defaultType - the default type for the match function
 * @returns {Function} the resulting function
 * 
 * @example var matchWeekdaysPatterns = { narrow: /^(su|mo|tu|we|th|fr|sa)/i,
 *          short: /^(sun|mon|tue|wed|thu|fri|sat)/i, long:
 ...
 * 
 * @description Build match function from a single RegExp. Usually used for
 *              building `match.ordinalNumbers` property of the locale.
 * 
 * @param {Object}
 *          pattern - the RegExp
 * @returns {Function} the resulting function
 * 
 * @example locale.match.ordinalNumbers =
 *          buildMatchPatternFn(/^(\d+)(th|st|nd|rd)?/i)
 ...
 * @name buildParseFn
 * @category Locale Helpers
 * @summary Build `match.weekday`, `match.month` and `match.timeOfDay`
 *          properties for the locale.
 * 
 * @description Build `match.weekday`, `match.month` and `match.timeOfDay`
 *              properties for the locale used by `parse` function. The argument
 *              of the resulting function is the result of the corresponding
 *              match function (`match.weekdays`, `match.months` or
 *              `match.timesOfDay` respectively. See `buildMatchFn`).
 * 
 * @param {Object}
 *          values - the object with arrays of RegExps
 * @param {String}
 *          defaultType - the default type for the parser function
 * @returns {Function} the resulting function
 * 
 * @example var parseWeekdayPatterns = { any: [/^su/i, /^m/i, /^tu/i, /^w/i,
 *          /^th/i, /^f/i, /^sa/i] } locale.match.weekday =
 *          buildParseFn(matchWeekdaysPatterns, 'long') var matchResult =
 ...
 * 
 * @description Parses the match result into decimal number. Uses the string
 *              matched with the first set of parentheses of match RegExp.
 * 
 * @param {Array}
 *          matchResult - the object returned by matching function
 * @returns {Number} the parsed value
 * 
 * @example locale.match = { ordinalNumbers: (dirtyString) { return
 *          String(dirtyString).match(/^(\d+)(th|st|nd|rd)?/i) }, ordinalNumber:
 *          parseDecimal }
 */
...
// Generally, formatted dates should look like they are in the middle of a
// sentence,
...
// `timeOfDay` is used to designate which part of the day it is, when used with
// 12-hour clock.
// Use the system which is used the most commonly in the locale.
// For example, if the country doesn't use a.m./p.m., you can use
 ...
 * 
 * @description Return the date parsed from string using the given format.
 * 
 * Accepted format tokens: | Unit | Priority | Token | Input examples |
 * |-------------------------|----------|-------|----------------------------------| |
 * Year | 10 | YY | 00, 01, ..., 99 | | | | YYYY | 1900, 1901, ..., 2099 | | ISO
 * week-numbering year | 10 | GG | 00, 01, ..., 99 | | | | GGGG | 1900, 1901,
 * ..., 2099 | | Quarter | 20 | Q | 1, 2, 3, 4 | | | | Qo | 1st, 2nd, 3rd, 4th | |
 * Month | 30 | M | 1, 2, ..., 12 | | | | Mo | 1st, 2nd, ..., 12th | | | | MM |
 * 01, 02, ..., 12 | | | | MMM | Jan, Feb, ..., Dec | | | | MMMM | January,
 * February, ..., December | | ISO week | 40 | W | 1, 2, ..., 53 | | | | Wo |
 * 1st, 2nd, ..., 53rd | | | | WW | 01, 02, ..., 53 | | Day of week | 50 | d |
 * 0, 1, ..., 6 | | | | do | 0th, 1st, ..., 6th | | | | dd | Su, Mo, ..., Sa | | | |
 * ddd | Sun, Mon, ..., Sat | | | | dddd | Sunday, Monday, ..., Saturday | | Day
 * of ISO week | 50 | E | 1, 2, ..., 7 | | Day of month | 50 | D | 1, 2, ..., 31 | | | |
 * Do | 1st, 2nd, ..., 31st | | | | DD | 01, 02, ..., 31 | | Day of year | 50 |
 * DDD | 1, 2, ..., 366 | | | | DDDo | 1st, 2nd, ..., 366th | | | | DDDD | 001,
 * 002, ..., 366 | | Time of day | 60 | A | AM, PM | | | | a | am, pm | | | | aa |
 * a.m., p.m. | | Hour | 70 | H | 0, 1, ... 23 | | | | HH | 00, 01, ... 23 | |
 * Time of day hour | 70 | h | 1, 2, ..., 12 | | | | hh | 01, 02, ..., 12 | |
 * Minute | 80 | m | 0, 1, ..., 59 | | | | mm | 00, 01, ..., 59 | | Second | 90 |
 * s | 0, 1, ..., 59 | | | | ss | 00, 01, ..., 59 | | 1/10 of second | 100 | S |
 * 0, 1, ..., 9 | | 1/100 of second | 100 | SS | 00, 01, ..., 99 | | Millisecond |
 * 100 | SSS | 000, 001, ..., 999 | | Timezone | 110 | Z | -01:00, +00:00, ...
 * +12:00 | | | | ZZ | -0100, +0000, ..., +1200 | | Seconds timestamp | 120 | X |
 * 512969520 | | Milliseconds timestamp | 120 | x | 512969520900 |
 * 
 * Values will be assigned to the date in the ascending order of its unit's
 * priority. Units of an equal priority overwrite each other in the order of
 * appearance.
 * 
 * If no values of higher priority are parsed (e.g. when parsing string 'January
 * 1st' without a year), the values will be taken from 3rd argument `baseDate`
 * which works as a context of parsing.
 * 
 * `baseDate` must be passed for correct work of the function. If you're not
 * sure which `baseDate` to supply, create a new instance of Date:
 * `parse('02/11/2014', 'MM/DD/YYYY', new Date())` In this case parsing will be
 * done in the context of the current date. If `baseDate` is `Invalid Date` or a
 * value not convertible to valid `Date`, then `Invalid Date` will be returned.
 * 
 * Also, `parse` unfolds long formats like those in [format]{@link https://date-fns.org/docs/format}: |
 * Token | Input examples | |-------|--------------------------------| | LT |
 * 05:30 a.m. | | LTS | 05:30:15 a.m. | | L | 07/02/1995 | | l | 7/2/1995 | | LL |
 * July 2 1995 | | ll | Jul 2 1995 | | LLL | July 2 1995 05:30 a.m. | | lll |
 * Jul 2 1995 05:30 a.m. | | LLLL | Sunday, July 2 1995 05:30 a.m. | | llll |
 * Sun, Jul 2 1995 05:30 a.m. |
 * 
 * The characters wrapped in square brackets in the format string are escaped.
 * 
 * The result may vary by locale.
 * 
 * If `formatString` matches with `dateString` but does not provides tokens,
 * `baseDate` will be returned.
 * 
 * If parsing failed, `Invalid Date` will be returned. Invalid Date is a Date,
 * whose time value is NaN. Time value of Date: http://es5.github.io/#x15.9.1.1
 * 
 * @param {String}
 *          dateString - the string to parse
 * @param {String}
 *          formatString - the string of tokens
 * @param {Date|String|Number}
 *          baseDate - the date to took the missing higher priority values from
 * @param {Options}
 *          [options] - the object with options. See [Options]{@link https://date-fns.org/docs/Options}
 * @param {0|1|2}
 *          [options.additionalDigits=2] - passed to `toDate`. See [toDate]{@link https://date-fns.org/docs/toDate}
 ...
 *          [options.locale=defaultLocale] - the locale object. See [Locale]{@link https://date-fns.org/docs/Locale}
 * @param {0|1|2|3|4|5|6}
 *          [options.weekStartsOn=0] - the index of the first day of the week (0 -
 *          Sunday)
 ...
 *           `options.locale` must contain `formatLong` property
 * 
 * @example // Parse 11 February 2014 from middle-endian format: var result =
 *          parse( '02/11/2014', 'MM/DD/YYYY', new Date() ) //=> Tue Feb 11 2014
 *          00:00:00
 * 
 * @example // Parse 28th of February in English locale in the context of 2010
 *          year: import eoLocale from 'date-fns/locale/eo' var result = parse(
 *          '28-a de februaro', 'Do [de] MMMM', new Date(2010, 0, 1) {locale:
 *          eoLocale} ) //=> Sun Feb 28 2010 00:00:00
 */
function parse(dirtyDateString, dirtyFormatString, dirtyBaseDate, dirtyOptions) {
  ...
  // This ensures that when UTC functions will be implemented, locales will be
	// compatible with them.
  // See an issue about UTC functions:
	// https://github.com/date-fns/date-fns/issues/37
 ...
 *          date - the date to be changed
 * @param {Number}
 *          amount - the amount of minutes to be subtracted
 * @param {Options}
 *          [options] - the object with options. See [Options]{@link https://date-fns.org/docs/Options}
 * @param {0|1|2}
 *          [options.additionalDigits=2] - passed to `toDate`. See [toDate]{@link https://date-fns.org/docs/toDate}
 ...
 *           `options.additionalDigits` must be 0, 1 or 2
 * 
 * @example // Subtract 30 minutes from 10 July 2014 12:00:00: var result =
 *          subMinutes(new Date(2014, 6, 10, 12, 0), 30) //=> Thu Jul 10 2014
 *          11:30:00
 */
 ...
 * 
 * If an argument is a string, the function tries to parse it. Function accepts
 * complete ISO 8601 formats as well as partial implementations. ISO 8601:
 * http://en.wikipedia.org/wiki/ISO_8601
 * 
 * If the argument is null, it is treated as an invalid date.
 * 
 * If all above fails, the function passes the given argument to Date
 * constructor.
 * 
 * **Note**: *all* Date arguments passed to any *date-fns* function is processed
 * by `toDate`. All *date-fns* functions will throw `RangeError` if
 * `options.additionalDigits` is not 0, 1, 2 or undefined.
 * 
 * @param {*}
 ...
 *          [options] - the object with options. See [Options]{@link https://date-fns.org/docs/Options}
 * @param {0|1|2}
 *          [options.additionalDigits=2] - the additional number of digits in
 *          the extended year format
 ...
 *           `options.additionalDigits` must be 0, 1 or 2
 * 
 * @example // Convert string '2014-02-11T11:30:30' to date: var result =
 *          toDate('2014-02-11T11:30:30') //=> Tue Feb 11 2014 11:30:30
 * 
 * @example // Convert string '+02014101' to date, // if the additional number
 *          of digits in the extended year format is 1: var result =
 *          toDate('+02014101', {additionalDigits: 1}) //=> Fri Apr 11 2014
 *          00:00:00
 */
function toDate(argument, dirtyOptions) {
  ...
  if (argument instanceof Date) {
    // Prevent the date to lose the milliseconds when passed to new Date() in
		// IE10
    ...
    StringMask.prototype.process = function proccess(value) {
        ...
        function continueCondition(options) {
            if (!inRecursiveMode && !recursive.length && hasMoreTokens(pattern2, patternPos, steps.inc)) {
                ...
                // Note: all chars in the patterns after the recursive portion
								// will be handled as static string
                return true;
        ...
        /**
				 ...
				 * chars until the end of the pattern. If the pattern ends with
				 * recursive chars the iteration will continue until the end of the
				 * input value.
				 * 
        ...
        for (patternPos = steps.start; continueCondition(this.options); patternPos = patternPos + steps.inc) {
            ...
            if (recursive.length && token && !token.recursive) {
                // In the recursive portion of the pattern: tokens not recursive
								// must be seen as static chars
                token = null;
            }

            // 1. Handle escape tokens in pattern
            // go to next iteration: if the pattern char is a escape char or was
						// escaped
            ...
            // if there is a normal token in the recursive portion of the
						// pattern
            if (!inRecursiveMode && token && token.recursive) {
                // save it to repeat in the end of the pattern and handle the
								// value char now
                recursive.push(pc);
            } else if (inRecursiveMode && !vc) {
                // in recursive mode but value is finished. Add the pattern char
								// if it is not a recursive token
                formatted = concatChar(formatted, pc, this.options, token);
                continue;
            } else if (!inRecursiveMode && recursive.length > 0 && !vc) {
                // recursiveMode not started but already in the recursive
            ...
            if (!token) {
                ...
                // if token is optional, only add the value char if it matchs
								// the token pattern
                ...
                // if token isn't optional the value char must match the token
								// pattern
                formatted = concatChar(formatted, vc, this.options, token);
                valuePos = valuePos + steps.inc;
            } else if (!vc && token._default && this.options.usedefaults) {
                // if the token isn't optional and has a default value, use it
								// if the value is finished
...
var phoneMask8D = {
		...
		areaCode    : null,                                   // N/A
		simple      : new StringMask('0000-000-0000')         // N/A, so it's
																													// "simple"
	};
		...
		link: function(scope, element, attrs, ctrl) {
			...
			function parser(value) {
				...
				if (angular.isDefined(attrs.uiNegativeNumber)) {
					...
					// only apply the minus sign if it is negative or(exclusive) or the
					// first character
					// needs to be negative and the number is different from zero
